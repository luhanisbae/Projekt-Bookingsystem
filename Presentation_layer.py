...
class BookingSystem:
    ...
    def __init__(self, root):
        ...
        self._text1_label = Label(self._user_frame, text='Brugernavnet findes allerede. Vælg et andet.', fg='red')
        ...
        self._text2_label = Label(self._res_frame, text='OBS! Tjek, hvad du har indtastet.', font=('Helvetica', 15), fg='red')
    ...
    def add_to_listbox(self):
        if len(self._res_entry.get()) != 4 or 700 >= int(self._res_entry.get()) or int(self._res_entry.get()) >= 1600 or int(self._res_entry.get()) in self._res._reservation:
            self._text2_label.pack(side=BOTTOM)
        else:
            self._text2_label.forget()
